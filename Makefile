...
UNREALROOTPATH = /home/sbura/DevTools/GameEngine/UnrealEngine
GAMEPROJECTFILE =/home/sbura/Projects/SphereKiller/SphereKiller.uproject
...
TARGETS = \
	...
	UnrealServer \
	SphereKiller-Linux-Debug  \
	SphereKiller-Linux-DebugGame  \
	SphereKiller-Linux-Test  \
	SphereKiller-Linux-Shipping  \
	SphereKiller \
	SphereKillerEditor-Linux-Debug  \
	SphereKillerEditor-Linux-DebugGame  \
	SphereKillerEditor-Linux-Test  \
	SphereKillerEditor-Linux-Shipping  \
	SphereKillerEditor\
	configure
...
SphereKiller-Linux-Debug:
	 $(PROJECTBUILD) SphereKiller Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKiller-Linux-DebugGame:
	 $(PROJECTBUILD) SphereKiller Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKiller-Linux-Test:
	 $(PROJECTBUILD) SphereKiller Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKiller-Linux-Shipping:
	 $(PROJECTBUILD) SphereKiller Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKiller:
	 $(PROJECTBUILD) SphereKiller Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKillerEditor-Linux-Debug:
	 $(PROJECTBUILD) SphereKillerEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKillerEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SphereKillerEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKillerEditor-Linux-Test:
	 $(PROJECTBUILD) SphereKillerEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKillerEditor-Linux-Shipping:
	 $(PROJECTBUILD) SphereKillerEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SphereKillerEditor:
	 $(PROJECTBUILD) SphereKillerEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
