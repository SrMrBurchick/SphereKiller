...
ASphereKillerCharacter::ASphereKillerCharacter()
{
...
void ASphereKillerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ASphereKillerCharacter::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void ASphereKillerCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void ASphereKillerCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void ASphereKillerCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
